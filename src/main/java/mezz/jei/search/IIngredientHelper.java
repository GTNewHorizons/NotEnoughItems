...
public interface IIngredientHelper<V> {
    ...
    /**
     * Expands any wildcard ingredients into all its subtypes. Ingredients like FluidStack that have no wildcard
     * ingredients should simply return the collection without editing it.
     *
     * @since JEI 3.11.0 Has a default implementation since JEI 4.14.2
     */
    ...
    /**
     * Change one focus into a different focus. This can be used to treat lookups of one focus as if it were something
     * else.
     *
    ...
    /**
     * Find a matching ingredient from a group of them. Used for finding a specific focused ingredient in a recipe.
    ...
    /**
     * Wildcard ID for use in comparing, blacklisting, and looking up ingredients. For an example, ItemStack's
     * wildcardId does not include NBT or meta. For ingredients like FluidStacks which do not have a wildcardId, just
     * return the uniqueId here.
     *
     * @since JEI 3.11.0
     */
    ...
    /**
     * Get the main colors of this ingredient. Used for the color search. If this is too difficult to implement for your
     * ingredient, just return an empty collection.
     *
     * @since JEI 3.11.0 Has a default implementation since JEI 4.14.2
     */
    ...
    /**
     * Makes a copy of the given ingredient. Used by JEI to protect against mutation of ingredients.
     *
    ...
    /**
     * This is called when connecting to a server, to hide ingredients that are missing on the server. This call must be
     * fast, the client should already know the answer without making any network calls. If in doubt, just leave this
     * with the default implementation and return true.
     *
     * @param ingredient the ingredient to check
    ...
    /**
     * Get a list of ore dictionary names that include this ingredient. Used for searching by ore dictionary name.
     *
     * @since JEI 4.14.2
     */
    ...
    /**
     * Get a list of creative tab names that include this ingredient. Used for searching by creative tab name.
     *
     * @since JEI 4.14.2
     */
    ...
    /**
     * Get information for error messages involving this ingredient. Be extremely careful not to crash here, get as much
     ...
     * <p>
     * This method can either: return an ItemStack for JEI to give the player, or return an empty ItemStack and handle
     * the action manually.
     *
     * @param ingredient The ingredient to cheat in. Do not edit this ingredient.
     * @param fullStack  Only used for manual handling, true if a full stack should be cheated in instead of a single
     *                   ingredient.
